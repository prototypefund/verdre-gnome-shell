...
var SearchResultsBase = class {
    ...
    _activateResult(result) {
        this.provider.activateResult(result.metaInfo.id, this._terms);
...
var SearchResults = class {
    ...
    _reset() {
        this._terms = [];
        this._results = {};
        this._providers.forEach(provider => provider.display.cleanup());
